...
function M.search_for_function(func_name)
  local search_patterns = {
    "exports%." .. func_name,         -- exports.funcName
    "module%.exports%." .. func_name, -- module.exports.funcName
    func_name .. ":%s*function",      -- funcName: function()
    func_name .. ":%s*[^,}]+",        -- funcName: anything
    "function " .. func_name,         -- function funcName()
    func_name .. "%s*=",              -- funcName =
    '"' .. func_name .. '"',          -- "funcName" (string key)
    "'" .. func_name .. "'",          -- 'funcName' (string key)
    func_name .. "%s*(",              -- funcName( (function call pattern)
  }
